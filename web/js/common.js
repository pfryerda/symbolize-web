...
var SCALING = 100,          //Define Grid size (100 x 100)
    ...
    ROTATIONFRAMES = 1//4750;  //Number of frames in rotation animation (larger equals slower)
    ROTATIONDROPOFF = 0//73;   //Number of frames dorp off per extra line in puzzle
    FLIPPINGFRAMES = 1//5250;  //Number of frames in flipping animation (larger equals slower)
    FLIPPINGDROPOFF = 0//73;   //Number of frames dorp off per extra line in puzzle
